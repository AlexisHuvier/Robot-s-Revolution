...
try:
    from files.pathfinding.utils import DiagonalMovement, manhatten, octile, backtrace, bi_backtrace
    from files.pathfinding.finder import Finder, TIME_LIMIT, MAX_RUNS, BY_START, BY_END
except ImportError:
    from utils import DiagonalMovement, manhatten, octile, backtrace, bi_backtrace
